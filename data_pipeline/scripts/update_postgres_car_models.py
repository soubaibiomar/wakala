...
async def update_database():
    with open('/app/data_pipeline/scripts/curated_studio_images.json', 'r', encoding='utf-8') as f:
        curated = json.load(f)

    with open('/app/data_pipeline/scripts/scraped_moteur_images.json', 'r', encoding='utf-8') as f:
        scraped = json.load(f)
