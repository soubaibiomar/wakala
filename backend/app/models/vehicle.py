...
class Vehicle(Base):
    ...
    official_consumption: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
    real_consumption: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
