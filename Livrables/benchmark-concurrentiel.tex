...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \textbf{Recommandation dynamique et prédictive} : Le système apprend en continu des interactions de l'utilisateur (temps de rétention sur une annonce, clics sur les photos, historique de navigation) pour adapter l'affichage en temps réel via des modèles de filtrage collaboratif et de recommandation hybrides.
        ...
        \item \textbf{Modélisation prédictive avancée} : Utilisation de modèles d'Intelligence Artificielle (ex. : Qdrant, Neo4j) pour capturer les nuances des besoins de l'utilisateur et proposer une recommandation de véhicules hyper-personnalisée, s'éloignant des simples filtres de recherche classiques.
    \end{itemize}
\end{description}

\subsection{Importance Stratégique pour le Projet Wakala}
Cette distinction méthodologique est cruciale pour le projet Wakala. Le marché de l'automobile d'occasion, particulièrement au Maroc, souffre d'une forte complexité technique et d'un manque d'accompagnement personnalisé. Les plateformes traditionnelles se contentent de numériser les petites annonces papier sans apporter de valeur ajoutée à l'analyse de la donnée. 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'absence totale d'assistance automatisée (Chatbot) pour orienter un acheteur novice. Par exemple, chercher "voiture familiale économique" ne renvoie aucun résultat pertinent sur Avito, car le site ne comprend pas ces concepts.
        \item Pas d'outil d'évaluation de prix intégré permettant de savoir si une annonce est surévaluée ou conforme au marché.
        \item Une expérience utilisateur froide et purement transactionnelle, laissant l'acheteur seul face à la difficulté de trouver le modèle correspondant à son style de vie.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Une recommandation limitée au ciblage publicitaire classique, sans analyse prédictive du comportement en temps réel.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Recommandation de l'affichage efficace et rapide, augmentant la conversion sans alourdir le parcours de recherche classique.
    \end{itemize}
    \item \textbf{Limites} :
    \begin{itemize}
        ...
        \item Recommandation sémantique limitée (la recherche reste structurée par des mots-clés et des filtres stricts).
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Une assise historique lié à sa présence omnicanale.
    \end{itemize}
    \item \textbf{Limites} :
    \begin{itemize}
...
Les géants internationaux illustrent la transition vers l'hybridation. Les acteurs purement analytiques (CarMax, CarGurus) sont contraints d'adopter des briques d'IA générative et de recommandation dynamique pour ne pas perdre l'initiative face aux acteurs natifs de l'IA (Carvana). Cette dynamique valide la pertinence de concevoir directement une architecture combinant ces deux aspects dès le départ.
\end{insightbox}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llp{3cm}p{6.5cm}}
    ...
    \addlinespace
    \textbf{Carvana} & International & IA-driven & Expérience d'achat 100\,\% en ligne avec recommandation et logistique. \\
    \addlinespace
    ...
    \addlinespace
    \midrule
    \textbf{Wakala} & Marocain & Hybride & \textbf{Un Chatbot Assistant et un Moteur de Recommandation pour guider l'acheteur.} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}[htbp]
  ...
  \begin{tcolorbox}[colback=white, colframe=black!30!white, arc=1mm, width=\textwidth, before={\par\noindent\vspace{10pt}}, after=\vspace{10pt}]
    ...
    \begin{tabular}{llp{6.8cm}}
      ...
      \textbf{Couche 4 : IA \& ML/Graph} & $\rightarrow$ & Qwen (Local), Qdrant (Vectoriel), Neo4j (Graphe) \\
...
\begin{enumerate}
    \item \textbf{Couche 1 : Ingestion en temps réel (Apache Kafka)} : Capture instantanément les événements de navigation des utilisateurs et les flux d'annonces de partenaires. Cela permet d'alimenter directement la recommandation dynamique, à l'instar des systèmes réactifs de Carvana.
...
Le projet Wakala se positionne à la convergence de ces mondes. En s'appuyant sur deux piliers centraux -- un Chatbot IA qui écoute et conseille l'acheteur, et un Moteur de Recommandation qui trouve automatiquement la meilleure voiture -- Wakala apporte une réponse complète aux carences du marché marocain. 
Au lieu de devoir chercher seul parmi des milliers d'annonces avec des mots-clés techniques, l'utilisateur marocain n'aura plus qu'à dire à Wakala : *"J'ai besoin d'une voiture robuste pour aller travailler à Casablanca, avec un budget de 80 000 DH"*. Le Chatbot lui posera les bonnes questions, et le Moteur de Recommandation lui servira les 3 options parfaites. Cette approche innovante permet d'offrir une expérience utilisateur de niveau international tout en s'adaptant aux réalités locales de la transaction de pair à pair au Maroc, remplaçant la recherche solitaire par un véritable accompagnement.
